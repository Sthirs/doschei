...
| [ADR-0025](0025-web-push-notifications.md) | Web Push notifications for ledger and invitation events — VAPID, injectManifest, server-side localization | 🟡 proposed |
