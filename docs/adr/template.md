...
What did we decide? One clear, active sentence ("We will …").
...
comparable systems. `AGENTS.md` requires capturing and citing what informed the decision; write
"None — trivial/reversible" only when that is genuinely true.
